// Masthead for the hackathons screen: the wordmark + a live, filter-aware
// count of upcoming hackathons. Mirrors the internships Header.
    ...
    <header className="relative z-10">
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-md text-sm leading-relaxed text-ink-soft">
            Upcoming hackathons — online and across the US — from MLH and
            Devpost, sorted by what&apos;s soonest.
          </p>
        </div>
      ...
      <div className="mt-7 flex items-baseline gap-3">
        ...
        <span className="text-2xl font-semibold text-ink sm:text-3xl">
          upcoming {count === 1 ? "hackathon" : "hackathons"}
